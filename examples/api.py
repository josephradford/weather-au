...
# (other methods will also return None if the search fails).
if location is None:
...
print(
    f"Forecast Rain:       amount:{forecast_rain['amount']}, "
    f"chance:{forecast_rain['chance']}"
)
