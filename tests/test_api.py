...
def test_search_single_endeavour_hills_hyphen():
    assert w4.geohash is None
...
def test_search_repr_endeavour_hills():
    ...
    expected = "WeatherApi(geohash='r1prcr', search='Endeavour Hills VIC', debug=0)"
    assert expected in repr(w5)
