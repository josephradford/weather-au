...
def test_station_list():
    ...
    for station in stations:
        ...
        obs_data.air_temperature(station["wmo-id"])
...
def test_description():
    wmo_id = "95936"
    expected = "Melbourne (Olympic Park)"
    assert obs_data.station_attribute(wmo_id, "description") == expected
